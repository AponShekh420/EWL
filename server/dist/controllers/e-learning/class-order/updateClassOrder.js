...
exports.updateClassOrder = void 0;
...
const updateClassOrder = async (req, res, next) => {
    ...
    try {
        ...
        // Find old order
        const oldOrder = await ClassOrderModel_1.ClassOrderModel.findById(id);
        if (!oldOrder)
            return next((0, http_errors_1.default)(404, "Order not found"));
        const updatedData = { ...body };
        // ---- UPDATE ORDER ----
        const updatedOrder = await ClassOrderModel_1.ClassOrderModel.findByIdAndUpdate(id, updatedData, {
            new: true,
            runValidators: true,
        });
        if (!updatedOrder)
...
exports.updateClassOrder = updateClassOrder;
