...
const updateCourse = async (req, res, next) => {
    try {
        ...
        if (body.speaker !== oldCourse.speaker) {
            await UserModel_1.default.updateOne({ courses: { $in: [oldCourse._id] } }, { $pull: { courses: oldCourse._id } });
            await UserModel_1.default.updateOne({ _id: body.speaker }, { $push: { courses: oldCourse._id } });
        }
        // ---- RESPONSE ----
