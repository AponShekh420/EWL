...
exports.getCourseByFilterFrontEnd = void 0;
const http_errors_1 = __importDefault(require("http-errors"));
const catchErrorSend_1 = require("../../../utils/catchErrorSend");
const CourseModel_1 = __importDefault(require("../../../models/CourseModel"));
const getCourseByFilterFrontEnd = async (req, res, next) => {
    try {
        ...
        const total = await CourseModel_1.default.countDocuments();
        res.status(200).json({
            success: true,
            data: courses,
            pagination: {
...
exports.getCourseByFilterFrontEnd = getCourseByFilterFrontEnd;
