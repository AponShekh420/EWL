...
exports.validateBlogSubcategory = exports.blogSubcategoryValidationRules = void 0;
const express_validator_1 = require("express-validator");
const deleteFileFromLocal_1 = require("../../utils/deleteFileFromLocal");
exports.blogSubcategoryValidationRules = [
...
const validateBlogSubcategory = (req, res, next) => {
    ...
    const imageDeleteHandler = () => {
        (0, deleteFileFromLocal_1.deleteFileFromLocal)(file.filename, "blog-subcategory");
    };
...
exports.validateBlogSubcategory = validateBlogSubcategory;
