...
exports.validateUpdateClass = exports.validateClass = exports.classValidationRules = void 0;
...
const validateClass = (req, res, next) => {
    ...
    const imageDeleteHandler = () => {
        if (req.files) {
            ...
            files.forEach((file) => {
                (0, deleteFileFromLocal_1.deleteFileFromLocal)(file.filename, "classes");
            });
        }
    };
