...
exports.validateResourcesCategory = exports.resourcesCategoryValidationRules = void 0;
const express_validator_1 = require("express-validator");
const deleteFileFromLocal_1 = require("../../utils/deleteFileFromLocal");
exports.resourcesCategoryValidationRules = [
    (0, express_validator_1.body)("name").notEmpty().withMessage("Category name is required"),
    (0, express_validator_1.body)("description").notEmpty().withMessage("Description is required"),
];
const validateResourcesCategory = (req, res, next) => {
    ...
    const imageDeleteHandler = () => {
        (0, deleteFileFromLocal_1.deleteFileFromLocal)(file.filename, "blog-category");
    };
...
exports.validateResourcesCategory = validateResourcesCategory;
