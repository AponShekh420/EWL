...
import { addClassCheckoutField } from "@/redux/features/checkout/classCheckoutFormSlice";
type SelectBoxFiled = {
  label: string;
  value: string;
};
...
export default function CheckoutForm() {
  ...
  const {errors} = useSelector((state: RootState) => state.classCheckout);
  ...
  return (
    <form action="" className="my-10  ">
      ...
      <div className="space-y-8">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <InputBox
              ...
              onChange={(e) => dispatch(addClassCheckoutField({ email: e.target.value }))}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <InputBox
              ...
              onChange={(e) =>
                dispatch(addClassCheckoutField({ spouseName: e.target.value }))
              }
            />
            {errors?.spouseName && (
              <FieldDescription className="text-red-600">
          ...
          <div>
            <InputBox
              ...
              onChange={(e) =>
                dispatch(
                  addClassCheckoutField({ howDidYouHearAboutUs: e.target.value }),
                )
              }
            />
                ...
                <CommandGroup className="max-h-60 overflow-y-auto">
                  {countries.map((country) => (
                    <CommandItem
                      ...
                      value={country.label}
                      onSelect={() => {
                        dispatch(addClassCheckoutField({ country: {
                          value: country.value,
                          label: country.label
                        } }));
        ...
        <div>
          <InputBox
            ...
            onChange={(e) =>dispatch(addClassCheckoutField({ streetAddress: e.target.value }))}
          />
        ...
        <div>
          <InputBox
            ...
            onChange={(e) =>
              dispatch(addClassCheckoutField({ apartment: e.target.value }))
            }
          />
          {errors?.apartment && (
            <FieldDescription className="text-red-600">
        ...
        <div className="grid grid-cols-3 gap-4 items-center">
                  ...
                  <CommandGroup className="max-h-60 overflow-y-auto">
                    {states.map((state) => (
                      <CommandItem
                        ...
                        value={state.label}
                        onSelect={() => {
                          dispatch(addClassCheckoutField({ state: {
                            value: state.value,
                            label: state.label
                          }}));
                          setOpenState(false);
          ...
          <div>
            <InputBox
              ...
              onChange={(e) => dispatch(addClassCheckoutField({ city: e.target.value }))}
            />
            {errors?.city && (
              <FieldDescription className="text-red-600">
                {errors?.city?.msg}
          ...
          <div>
            <InputBox
              ...
              onChange={(e) => dispatch(addClassCheckoutField({ zipCode: e.target.value }))}
            />
            {errors?.zip && (
              <FieldDescription className="text-red-600">
                {errors?.zip?.msg}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <InputBox
              ...
              onChange={(e) =>
                dispatch(addClassCheckoutField({ phoneNumber: e.target.value }))
              }
            />
            {errors?.phoneNumber && (
              <FieldDescription className="text-red-600">
          ...
          <InputBox
            ...
            onChange={(e) =>
              dispatch(addClassCheckoutField({ otherPhoneNumber: e.target.value }))
            }
          />
      ...
      <TextBox
        ...
        onChange={(e)=> dispatch(addClassCheckoutField({orderNotes: e.target.value}))}
      />
    </form>
  );
}
