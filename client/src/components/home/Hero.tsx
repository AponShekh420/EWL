    ...
    <div className="bg-[url('/images/home/hero.png')] bg-cover bg-center bg-no-repeat bg-blend-overlay bg-black/15">
      <div className="container md:py-20 py-10">
        ...
        <FadeInSection
          ...
          delay={0.11}
        > 
          <Link href={"/free-demos"} className="bg-[#0F75BC] px-5 py-2 h-9 rounded-full font-semibold text-white text-sm lg:text-md text-nowrap shadow-[5px_5px_15px_0px_#2700346c] hover:shadow-[5px_5px_15px_0px_#dad7dc6c] transition-all duration-150 transform hover:translate-y-[-5px] capitalize">free classes</Link>
