    ...
    <section className="mt-20">
      <div className="container">
        <div className="text-center max-w-[700px] mx-auto">
          <h1 className="text-3xl font-bold">From Struggle to Strength</h1>
        ...
        <div className="grid grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-16 mt-20">
          {struggleToStrengthData.map((data) => (
            <div
              key={data.id}
              className="text-center border border-teal px-4 pt-18 pb-4 relative"
            >
              <span className="bg-teal size-24 flex items-center justify-center text-white text-4xl font-bold rounded-full absolute top-[-25%] right-1/2 translate-x-1/2">
                {data.id}
              </span>
      ...
      <div className="bg-darkPink text-white py-14 mt-14">
        <div className="text-center max-w-[800px] mx-auto">
          ...
          <Button className="bg-teal text-lg px-8 rounded-2xl">
